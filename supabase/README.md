...
3. Если ошибка **violates row-level security** — `20260316_fix_settings_rls.sql`
4. Для шаблонов подэтапов домов — `20260316_setting_default_substeps.sql`
5. В приложении: Справочники → Этапы → «Заполнить шаблоном домов»
6. Для статусов при необходимости: `20260316_fix_status_labels_access.sql`.
